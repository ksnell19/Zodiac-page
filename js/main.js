var aquarius = {
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/aquarius.png?raw=true'
};
...
var pisces = {
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/pisces.png?raw=true',
};
...
var aries = {
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/aries.png?raw=true'
};
...
var taurus = {
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/taurus.png?raw=true'
};
var gemini = {
  name: 'gemini',
  date: 'May 21 - June 20',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/gemini.png?raw=true'
};
var cancer = {
  name: 'cancer',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/cancer.png?raw=true'
};
var leo = {
  name: 'leo',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/leo.png?raw=true'
};
var virgo = {
  name: 'virgo',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/virgo.png?raw=true'
};
var libra = {
  name: 'libra',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/libra.png?raw=true'
};
var scorpio = {
  name: 'scorpio',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/scorpio.png?raw=true'
};
var sagittarius = {
  name: 'sagittarius',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/sagittarius.png?raw=true'
};
var capricorn = {
  name: 'capricorn',
  ...
  img: 'https://github.com/ksnell19/Zodiac-page/blob/master/img/capricorn.png?raw=true'
};
